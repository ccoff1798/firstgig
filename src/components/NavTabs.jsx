...
function NavTabs() {
  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-light justify-start">
      ...
      <div className={`${isNavCollapsed ? 'collapse' : 'justify-start'} navbar-collapse`} id="navbarNav">
